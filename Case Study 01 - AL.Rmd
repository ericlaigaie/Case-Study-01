...
new_df2 %>% group_by(Region) %>% ggplot(aes(x=ABV,y=IBU,col=Style_Group)) + geom_point() + labs(title = 'ABV vs IBU by Region by Style Group') + geom_smooth(method = 'lm')+ facet_wrap(~Region)
