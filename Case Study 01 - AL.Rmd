...
regions = as.data.frame(read.csv('/Users/alexanderlopez/Documents/SMU/Classes/MSDS_6306_Doing_Data_Science/Case_Study_1/Case-Study-01/state_regions.csv', header = TRUE))
...
new_df2 %>% group_by(Region) %>% summarise(meanABV = mean(ABV),meanIBU = mean(IBU)) %>% ggplot(aes(x=meanABV, y=meanIBU,color=Region)) + geom_point(stat = 'identity')
